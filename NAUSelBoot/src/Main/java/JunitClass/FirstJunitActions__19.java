...
public class FirstJunitActions__19 {
    ...
    public void aHover_Click() throws InterruptedException {
        ...
        Assertions.assertEquals("https://forum.jquery.com/",currUrl,"url mismatch!!!");
    ...
    public void cDragDrop() throws InterruptedException {
        ...
        //use actions class dragAndDrop methods to drag from one element to another element
        action.dragAndDrop(draggable,droppable).build().perform();
        Thread.sleep(5000);

        String actualText = droppable.findElement(By.tagName("p")).getText();
        Assertions.assertEquals("Dropped!",actualText);
    ...
    public void eSlider() throws InterruptedException {
        ...
        WebElement endSlider = driver.findElement(By.xpath("//div[@aria-label='Maxsimum price' and @role='slider']"));

        action.dragAndDropBy(startingSlider,100, 0).perform();  //drags and drops a slider element by offset given
        Thread.sleep(5000);
        action.dragAndDropBy(startingSlider,-50, 0).perform();  //drags and drops a slider element by offset given
